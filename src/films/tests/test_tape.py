...
def test01_construct(variant_scalar_acoustic, freq_bins, time_bins):
...
def test02_prepare(variant_scalar_acoustic, count):
...
@pytest.mark.parametrize("count", count_list)
def test03_prepare_sample(variant_scalar_acoustic, count):
